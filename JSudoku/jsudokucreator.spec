...
BuildArch: 			noarch
Packager:   		Reiner Pröls <jsudokucreator@googlemail.com>
...
Summary(de):		Programm zum Erzeugen, Lösen, Speichern und Drucken von Sudokus
...
%description -l de
JSudokuCreator ist ein Java Programm zum Erzeugen, Lösen und Drucken von Sudokus. JSudokuCreator ist ein Open Source Projekt das unter der GPL veröffentlicht wird.
JSudokuCreator kann Sudokus erzeugen, lösen, ausdrucken und in Dateien speichern und von Dateine laden.
Zur Zeit ist JSudokuCreator in Deutsch und Englisch übersetzt.
Eine kurze Onlinehilfe ist verfügbar
...
%changelog
* Sun Nov 23 2008 Reiner Pröls
- small changes

* Fri Dec 28 2007 Reiner Pröls
- first version
